...
<Update label="2024/12/11 - 2024/12/18">
**Documentation Enhancement and SEO Optimization**
- Added SEO descriptions to over 400 product manual articles across English and Chinese versions
- Enhanced MPC wallet documentation with embedded videos in [Introduction to Organization-Controlled Wallets](/en/portal/mpc-wallets/ocw/introduction)
- Published new manuals for [Token Bridge](/en/portal/apps/bridge/introduction) (EN+CN) and [Screening](/en/portal/apps/screening/introduction) (EN)
- Added Intercom widget for improved user support

**Content Organization and Updates**
- Updated governance policies structure based on customer service feedback
- Enhanced bilingual glossary with additional key terms
- Reorganized style rules and bilingual glossary into dedicated folders
- Fixed minor issues in Token Bridge documentation
</Update>
